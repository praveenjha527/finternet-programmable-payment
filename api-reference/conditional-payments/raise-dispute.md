...
```bash
curl https://api.finternet.com/v1/payment-intents/intent_2xYz9AbC123/conditional-payment/dispute \
...
const response = await fetch(
  `https://api.finternet.com/v1/payment-intents/${intentId}/conditional-payment/dispute`,
  {
    method: 'POST',
    headers: {
...
response = requests.post(
    f'https://api.finternet.com/v1/payment-intents/{intent_id}/conditional-payment/dispute',
    headers={
